...
% Citation colors
\def\customcitecolor{purple}
\def\customlinkcolor{darkblue}

% Hyperref settings
\usepackage[pdfborder=0,colorlinks,citecolor=\customcitecolor,linkcolor=\customlinkcolor,urlcolor=darkblue]{hyperref}
