...
\begin{definition} A \textit{homotopy sheaf} is a strongly (=strictly, therefore unramified) $\A^1$-invariant sheaf of abelian groups. We denote by $\HI(k) \subseteq \Ab_\Nis(k)$ the full category of homotopy sheaves.
\end{definition}
