...
\begin{theorem} The category $\HI(k)$ admits a closed symmetric monoidal structure, which we denote by $\otimes_\HI$.
\end{theorem}
We'll come back and add a proof for this later. It is generally defined using a bit more machinery than we've developed so far, see e.g. \cite[4.2.1.20]{Feld-thesis}.
...
\begin{proposition} We have for any $M \in \HI(k)$
\begin{align*}
