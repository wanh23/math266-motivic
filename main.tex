...
Hence proving Murthy's conjecture reduces to showing the secondary obstruction vanishes. The hard part about this obstruction is that it is valued in $\pi_{d,0}(S^{2d-1,d})$. We understand a bit about the first stable homotopy groups of motivic spheres by work of R\"ondigs, Spitzweck and {\O}stv{\ae}r \cite{RSO}. Unfortunately, however, our sheaf of study lies outside the stable range.
