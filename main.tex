...
\begin{example} Some examples of $\tau$-sheaves:
\begin{enumerate}
    ...
    \item Any stack can be thought of as a sheaf
    \begin{align*}
        \mathcal{F}\colon \mathscr{C}^\op \to \Grpd,
    \end{align*}
    and under the nerve construction $N \colon \Grpd \to \sSet$ this can be thought of as a sheaf of spaces.
...
\subsection{Filtered and sifted colimits}
