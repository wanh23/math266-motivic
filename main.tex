...
Let $h_S \in \PSh(\Sm_S)$ denote the representable sheaf attached to the base. Then the map $h_S \xto{!} \Delta^0$ of presheaves is a local equivalence.\footnote{todo --- move this earlier}
\end{proposition}
