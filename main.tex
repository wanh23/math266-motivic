...
\end{align*}
\end{proposition}
\begin{proof} This is by adjunctions
\begin{align*}
    \left[ \Sigma^\infty \Sigma^n X_+, \HA \right]_{\Sp(k)} &= \left[ \Sigma^n X_+, \Omega^\infty \HA \right]_{\Shv_\Nis(\Sm_k)_\ast} \\
    &= \left[ X_+, K(A,n) \right]_{\Shv_\Nis(\Sm_k)_\ast}.
\end{align*}
\end{proof}
